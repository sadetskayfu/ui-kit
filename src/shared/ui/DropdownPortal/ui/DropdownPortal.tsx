...
export const DropdownPortal = forwardRef(
	(props: DropdownPortalProps, ref: React.ForwardedRef<HTMLDivElement>) => {
		const {
			className,
			position = 'bottom',
			children,
		...
		const handleChangePosition = useCallback(() => {
			...
			if (dropdown && parent) {
				setPositionPortalElement({ element: dropdown, parent, position })
			}
		}, [position, parentRef])
